...
export const BOTS: BotMeta[] = [
  ...
  },
  {
    ...
    prefix: "GRIDSIG_",
    tagline: "Handelt nur bestätigte Aufwärtstrends, setzt 25 € je Stufe ein und pausiert nach einem Verlust 30 Tage.",
    startingCapitalEur: 1000,
  },
];
  ...
  const strategies: StrategyGroup[] = [
    ...
    },
    {
      ...
      params: [
        { label: "Startkapital", value: "1.000 €" },
        { label: "Hebel", value: "2× isoliert" },
        { label: "Margin je Stufe", value: "25 €", hint: "Entspricht 50 € Positionswert." },
    ...
    },
    {
      ...
      currentBehavior: "Handelt rein simuliert mit 2 € und höchstens einer Position. Ein gerader Pump wird nicht mehr gekauft: Erst Anstieg, dann 7–25 % Rücksetzer und anschließend neuer Kaufdruck lösen einen Einstieg aus.",
      params: [
