...
REGIME_SMA_PERIOD_DAYS = int(os.getenv("SURF_REGIME_SMA_PERIOD_DAYS", "0"))
...
TRAILING_ACTIVATION_PCT = float(os.getenv("SURF_TRAILING_ACTIVATION_PCT", "0.0"))
...
async def main():
    ...
    bot = SurferBot(
        ...
        regime_sma_period_days=REGIME_SMA_PERIOD_DAYS,
